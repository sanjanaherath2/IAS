				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-lg-12 clear-padding-xs">
							<h5 class="page-title"><i class="fa fa-user"></i>ENROLL STUDENT</h5>
                                        ...
                                        <?php
                                            if(isset($_POST['submit'])){
                                                ...
                                                while($row = mysqli_fetch_assoc($userquery)){
                                                    echo "
                                                    <form action=\"php/admin-student-enroll-submit.php\" method=\"post\">
                                                        <div class=\"dash-form\">
                                                            <div class=\"col-sm-4\">
                                                          ...
                                                          echo "</select>
                                                            ...
                                                            <div class=\"col-sm-4\">
                                                                ...
                                                                <select name=\"lecturer_id\">";
                                                                    ...
                                                                    while($row = mysqli_fetch_assoc($lecturerquery)){                           echo "<option value=\"{$row['lecturer_id']}\">{$row['first_name']} {$row['last_name']}</option>";
                                                                    }
                                                          echo "</select>
                                                            </div>
                                                            ...
                                                            <div class=\"col-sm-4\">
                                                                <br><br>
                                                                <input style=\"background-color:#ed1d24; color:#fff;\" type=\"submit\" value=\"ENROLL\" name=\"enroll\">
                                                            </div>  
                                                        </div>
                                                    </form>
                                                    ";
