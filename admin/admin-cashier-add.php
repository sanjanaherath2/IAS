...
<head>
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-lg-12 clear-padding-xs">
							<h5 class="page-title"><i class="fa fa-user"></i>ADD CASHIER</h5>
							...
							<div class="col-md-12">
								<div class="dash-item first-dash-item">
									...
									<div class="inner-item">
                                        ...
                                        <form action="php/admin-cashier-add-submit.php" method="post">
                                            <div class="dash-form">
                                                <div class="col-sm-4">
                                                    <label class="clear-top-margin"><i class="fa fa-user-circle-o"></i>CASHIER ID</label>
                                                    <input type="text" placeholder="xxExx" name="cashier_id" />
                                                </div>
                                                <div class="col-sm-4">
                                               ...
                                               <div class="col-sm-4">
                                                    ...
                                                    <input type="text" placeholder="07xxxxxxxx" name="phone" />
                                                </div>
                                                <div class="col-sm-4">
    ...
    <!--												<a href="#"><i class="fa fa-paper-plane"></i> SAVE</a>-->
                                                    <br><br>
                                                    <input style="background-color:#ed1d24; color:#fff;" type="submit" value="ADD CASHIER" name="submit">
                                                </div>                                                                                         
                                            </div>
                                        </form>
