										...
										<table id="attendenceDetailedTable" class="display responsive nowrap" cellspacing="0" width="100%">
											<thead>
												<tr>
													...
													<th><i class="fa fa-book"></i>LAST NAME</th>									<th><i class="fa fa-envelope-o"></i>ACTION</th>
												</tr>
											</thead>
											<tbody>
											<?php
											...
											while($row = $result->fetch_assoc()) {
											 echo 
												"<tr>
                                                    ...
                                                    <td>".$row['last_name']."</td>
                                                    <td> 
                                                            <form action =\"admin-student-id-inner.php\" method=\"post\" >
                                                                <input type=\"hidden\" value=" .$row['student_id']. " name=\"student_id\">
                                                                <input class=\"delete-btn\" type=\"submit\" name=\"submit\" value=\"View Student ID\">
                                                            </form>
                                                    </td>
                                                </tr>";
