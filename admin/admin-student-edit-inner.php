                                        ...
                                        <?php
                                            if(isset($_POST['submit'])){
                                                ...
                                                while($row = mysqli_fetch_assoc($userquery)){
                                                    echo "
                                                    <form action=\"php/admin-student-edit-submit.php\" method=\"post\">
                                                        <div class=\"dash-form\">
                                                            <div class=\"col-sm-4\">
                                                                <label class=\"clear-top-margin\"><i class=\"fa fa-user-user-circle-o\"></i>STUDENT ID</label>
                                                            ...
                                                            <div class=\"col-sm-3\">
                                                                <br><br>
                                                                <input style=\"background-color:#ed1d24; color:#fff;\" type=\"submit\" value=\"UPDATE STUDENT\" name=\"submit\">
                                                            </div>                                                                                         
                                                        </div>
                                                    </form>
                                                    ";
