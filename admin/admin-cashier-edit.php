				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-lg-12 clear-padding-xs">
							<h5 class="page-title"><i class="fa fa-users"></i>ALL CASHIER</h5>
						...
						<div class="col-lg-12 clear-padding-xs">
							<div class="col-lg-12">
								<div class="dash-item first-dash-item">
									<h6 class="item-title"><i class="fa fa-user"></i>CASHIER</h6>
									<div class="inner-item">
										<table id="attendenceDetailedTable" class="display responsive nowrap" cellspacing="0" width="100%">
											<thead>
												<tr>
													<th><i class="fa fa-user"></i>CASHIER ID</th>
													<th><i class="fa fa-id-card"></i>FIRST NAME</th>
													<th><i class="fa fa-book"></i>LAST NAME</th>
													<th><i class="fa fa-cogs"></i>ADDRESS</th>
											...
											while($row = $result->fetch_assoc()) {
											 echo 
												...
												<td> ".$row['email']."</td>
                                                <td> 
                                                        <form action =\"admin-cashier-edit-inner.php\" method=\"post\" >
                                                            <input type=\"hidden\" value=" .$row['cashier_id']. " name=\"cashier_id\">
                                                            <input class=\"delete-btn\" type=\"submit\" name=\"submit\" value=\"Edit\">
                                                        </form>
                                                </td>
												</tr>";
