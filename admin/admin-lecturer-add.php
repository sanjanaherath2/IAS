...
<head>
							...
							<div class="col-md-12">
								<div class="dash-item first-dash-item">
									...
									<div class="inner-item">
                                        ...
                                        <form action="php/admin-lecturer-add-submit.php" method="post">
                                            <div class="dash-form">
                                                <div class="col-sm-4">
                                                    <label class="clear-top-margin"><i class="fa fa-user-circle-o"></i>LECTURER ID</label>
                                                    <input type="text" placeholder="xxExx" name="lecturer_id" />
                                                </div>
                                                <div class="col-sm-4">
                                                ...
                                                <div class="col-sm-4">
                                                    ...
                                                    <input type="text" placeholder="xxxxxxxxxV" name="nic" />
                                                </div>
                                                <div class="clearfix"></div>
                                                <div class="col-sm-4">
    ...
    <!--												<a href="#"><i class="fa fa-paper-plane"></i> SAVE</a>-->
                                                    <br><br>
                                                    <input style="background-color:#ed1d24; color:#fff;" type="submit" value="ADD LECTURER" name="submit">
                                                </div>                                                                                         
                                            </div>
                                        </form>
