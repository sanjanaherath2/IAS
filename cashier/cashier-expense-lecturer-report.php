				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-lg-12 clear-padding-xs">
							<h5 class="page-title"><i class="fa fa-users"></i>EXPENSES REPORT (Based on Lecturers)</h5>
							...
							<div class="col-lg-12">
								<div class="dash-item first-dash-item">
									...
									<div class="inner-item">
                                        <form action="cashier-expense-lecturer-report.php" method="post">
                                                        <div class="dash-form">
										...
										<table id="attendenceDetailedTable" class="display responsive nowrap" cellspacing="0" width="100%">
											<thead>
												<tr>
													...
													<th><i class="fa fa-id-card"></i>EXPENSE</th>
