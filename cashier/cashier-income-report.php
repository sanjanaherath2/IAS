				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-lg-12 clear-padding-xs">
							<h5 class="page-title"><i class="fa fa-users"></i>INCOME REPORT</h5>
						...
						<div class="col-lg-12 clear-padding-xs">
							<div class="col-lg-12">
								<div class="dash-item first-dash-item">
									<h6 class="item-title"><i class="fa fa-user"></i>INCOME</h6>
									<div class="inner-item">
                                       <form action="cashier-income-report.php" method="post">
                                                        <div class="dash-form">
										...
										<table id="attendenceDetailedTable" class="display responsive nowrap" cellspacing="0" width="100%">
											<thead>
												<tr>
													<th><i class="fa fa-user"></i>SUBJECTS</th>
													<th><i class="fa fa-id-card"></i>AMOUNT</th>
												</tr>
											</thead>
											<tbody>
											<?php 
                                                if(isset($_POST['submit'])){
                                                    ...
                                                    while($rowsubject = $resultsubject->fetch_assoc()) {
                                                     echo 
                                                        ...
                                                        $subID = $rowsubject['subject_id'];
                                                        $sqlamount = "SELECT amount FROM `monthly_fee` WHERE month= '$month' AND year='$year' AND subject_id='$subID'";
                                                        $resultamount = mysqli_query($connection, $sqlamount);
                                                        $totalAmount = 0;
                                                        while($rowamount = $resultamount->fetch_assoc()) {                                   $totalAmount = $totalAmount + $rowamount['amount']; 
                                                        }
                                                        echo "<td> ".$totalAmount."</td>";                                               $totalSalary = $totalSalary + $totalAmount;
                                                        ...
                                                        echo"
                                                        <tr>
                                                            <td class=\"bg-red\">TOTAL SALARY EXPENSES</td>
                                                            <td class=\"bg-red\">$totalSalary</td>
                                                        </tr>
                                                        ";
                                                }
								            ?>												
