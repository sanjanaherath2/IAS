				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-lg-12 clear-padding-xs">
							<h5 class="page-title"><i class="fa fa-users"></i>EXPENSES REPORT (Based on Subject)</h5>
						...
						<div class="col-lg-12 clear-padding-xs">
							<div class="col-lg-12">
								<div class="dash-item first-dash-item">
									<h6 class="item-title"><i class="fa fa-user"></i>EXPENSES</h6>
									<div class="inner-item">
                                        <form action="cashier-expense-subject-report.php" method="post">
                                                        <div class="dash-form">
											...
											<?php   
                                                ...
                                                while($rowsubject = $resultsubject->fetch_assoc()) {
                                                 echo 
                                                    ...
                                                    $sqlamount = "SELECT amount FROM `salary` WHERE month= '$month' AND year='$year' AND subject_id='$subID'";
