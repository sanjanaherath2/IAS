							...
							<div class="col-lg-12">
								<div class="">
									<div class="inner-item dash-search-form">
                                        <form action="php/mark-student-attendence-submit.php" method="post">
                                            
                                                <?php
                                                    if(isset($_POST['mark'])){
                                                        $_SESSION['subject'] = $_POST['subject_id'];
                                                        $_SESSION['lecturer'] = $_POST['lecturer_id'];
                                                    }
                                                ?>
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                ...
                                                <input type="text" value="<?php echo $_SESSION['subject']; ?>" name="subject_id">
                                            </div>
                                            <div class="col-md-6 col-sm-6">
                                                <label>Lecturer Code</label>
                                                <input type="text" value="<?php echo $_SESSION['lecturer']; ?>" name="lecturer_id">
                                            </div>
										...
										<?php
											if(isset($_GET['msg'])){
												$student_id = urldecode(base64_decode(($_GET['msg'])));;
												...
												while($row = $result->fetch_assoc()) {
                                                    ...
                                                    <br><br>
                                                    <p align=\"center\">
                                                        <img src=\"../uploads/students/photos/".$row['photo']."\" width=\"200px\" height=\"200px\" \">
                                                    </p>
                                                    ";
