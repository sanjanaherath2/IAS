				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-lg-12 clear-padding-xs">
							<h5 class="page-title"><i class="fa fa-pencil-square-o"></i>SELECT TUTE</h5>
							...
							<div class="col-lg-12">
								<div class="dash-item first-dash-item">
									<div class="inner-item dash-search-form">
                                        <form action="mark-student-tute.php" method="post">
                                            <div class="col-md-4 col-sm-6">
												<label> TUTE ID</label>
													<?php echo	"<select name=\"tute_id\">
																		<option>-- Select --</option>";
																		$selecttutes = "SELECT tute_no FROM tutes";
																		$tutesquery = mysqli_query($connection,$selecttutes);
																		while($row = mysqli_fetch_assoc($tutesquery)){                           
																			echo "<option value=\"{$row['tute_no']}\">{$row['tute_no']}</option>";
																		}
															echo "</select> ";?>
											</div>
											...
											<div class="col-md-4 col-sm-6">
												<label> SUBJECT ID</label>
													<?php echo	"<select name=\"subject_id\">
																		<option>-- Select --</option>";
																		$selectsubject = "SELECT subject_id FROM subjects";
											...
											<div class="col-md-6 col-sm-6">
                                                <button type="submit" class="submit-btn" name="mark"><i class="fa fa-search"></i>Next</button>
                                            </div>
