				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-lg-12 clear-padding-xs">
							<h5 class="page-title"><i class="fa fa-pencil-square-o"></i>ADD TUTE</h5>
							...
							<div class="col-lg-12">
								<div class="dash-item first-dash-item">
									<div class="inner-item dash-search-form">
                                        <form action="php/add-student-tute-submit.php" method="post" enctype="multipart/form-data">
                                            <div class="col-md-3 col-sm-6">
                                                <label>TUTE ID</label>
                                                <input type="text" name="tute_no" placeholder="T-xx" required>
                                            </div>
											<div class="col-md-3 col-sm-6">
                                                <label>TUTE NAME</label>
                                                <input type="text" name="tute_name" placeholder="Management Accounting" required>
                                            </div>
											<div class="col-md-3 col-sm-6">
											...
											<div class="col-md-3 col-sm-6">
                                                    <label><i class="fa fa-file"></i> Upload PDF</label>
                                                    <input type="file" name="fileToUpload" id="fileToUpload">
                                                </div>
                                            <div class="col-md-3 col-sm-6">
                                                <button type="submit" class="submit-btn" name="mark" value = "MARK"><i class="fa fa-search"></i>ADD TUTES</button>
                                            </div>
											<div class="col-md-3 col-sm-6">
                                                <button type="submit" class="submit-btn" name="delete" value = "DELETE"><i class="fa fa-search"></i>DELETE TUTES</button>
                                            </div>
